-- On insère différents éléments dans la table "Segment"
...
-- On insère différents éléments dans la table "Salle"
...
-- On insère différents éléments dans la table "Poste"
...
-- On insère différents éléments dans la table "Types"
...
-- On modifie le champ "numIns" de la table "Installer" afin de le rendre auto-incrementé
ALTER TABLE Installer MODIFY COLUMN numIns INTEGER(5) AUTO_INCREMENT;

-- On insère différents éléments dans la table "Installer", dont le champ "numIns" sera auto-incrémenté à partir de 1
